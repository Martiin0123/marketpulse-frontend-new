...
export default function StatsOverview({ totalSignals, buySignals, sellSignals }: Props) {
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
      ...
      <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700 p-6">
        <div className="flex items-center">
          ...
          <div className="ml-4">
            <p className="text-sm font-medium text-gray-400">Total Signals</p>
      ...
      <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700 p-6">
        <div className="flex items-center">
          ...
          <div className="ml-4">
            ...
            <p className="text-xs text-green-400">{buyPercentage.toFixed(1)}%</p>
          </div>
        </div>
      </div>
