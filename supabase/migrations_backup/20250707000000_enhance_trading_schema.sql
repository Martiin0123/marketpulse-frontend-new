...
ADD COLUMN IF NOT EXISTS signal_source VARCHAR(50) DEFAULT 'ai_algorithm',
...
COMMENT ON COLUMN public.signals.signal_source IS 'Source of the signal (ai_algorithm, manual, etc.)';
